...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Yolo26s-seg onnx inference')
    parser.add_argument('-c', '--checkpoint_path', default="weights/yolo26s-seg.onnx",
                        help='Dataset version with choices')
    parser.add_argument('-i','--image_path', default="bus.jpg",
